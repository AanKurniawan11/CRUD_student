...
<header class="navbar sticky-top bg-white flex-md-nowrap p-0 shadow" data-bs-theme="dark" id="lol">
    <div class="container">
            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="height: 100vh">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 " href="/dash">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 " href="/dash/siswa/all   ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 " href="/kelaz/all   ">
                                <i class="fa-solid fa-user-tie"></i>
                                Kelas
                            </a>
                        </li>
